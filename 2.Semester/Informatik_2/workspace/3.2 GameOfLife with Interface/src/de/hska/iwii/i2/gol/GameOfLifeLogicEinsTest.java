 ...
 *
 */
public class GameOfLifeLogicEinsTest {
  ...
  public void testNextGeneration1() {
    ...
    GameOfLifeLogicEins golLogic = new GameOfLifeLogicEins();
    golLogic.setStartGeneration(newGame);
    golLogic.nextGeneration();
    
    // Alle lebenden Zellen haben genau drei lebende Nachbarn,
    // sollten also in der nächsten Generation weiterleben.
    ...
    // Alle nicht lebendigen Nachbarn der lebenden Zellen haben je nur 2
    // lebende Nachbarn, sollten also in der nächsten Generation tot bleiben.
